...
yhcminer-src := $(call my-dir)

LOCAL_PATH := $(yhcminer-src)
include $(CLEAR_VARS)

LOCAL_MODULE=yhcminer-jansson
...
LOCAL_C_INCLUDES := $(yhcminer-src)/compat/jansson
...
LOCAL_MODULE=yhcminer
LOCAL_MODULE_TAGS=optional
LOCAL_MODULE_CLASS := UTILITY_EXECUTABLES
LOCAL_MODULE_PATH := $(PRODUCT_OUT)/utilities
LOCAL_MODULE_STEM := $(LOCAL_MODULE)

LOCAL_C_INCLUDES := $(yhcminer-src)/compat/bionic \
  $(yhcminer-src)/compat/jansson \
...
LOCAL_STATIC_LIBRARIES := libm yhcminer-jansson
