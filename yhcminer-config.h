/* yhcminer-config.h.  Generated from yhcminer-config.h.in by configure.  */
/* yhcminer-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Name of package */
#define PACKAGE "yhcminer-multi"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT ""

/* Define to the full name of this package. */
#define PACKAGE_NAME "yhcminer-multi"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "yhcminer-multi 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "yhcminer-multi"
